  ...
  <Card className="mb-8 bg-white/5 border border-white/10">
          <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-6">
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <p className="text-gray-300 mb-3">Passionné de League of Legends depuis 2015</p>
          ...
          <div className="lg:col-span-1">
            <Card className="mb-6 bg-white/5 border border-white/10">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-1">Pseudo LoL</label>
                  <p className="text-white">JohnTheADC</p>
                </div>
                
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-1">Région</label>
                  <p className="text-white">EUW (Europe West)</p>
                </div>
                
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-1">Membre depuis</label>
                  <p className="text-white">Octobre 2024</p>
                </div>
                
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-1">Rôle principal</label>
                  <p className="text-white">ADC</p>
                </div>
              </div>
            </Card>
